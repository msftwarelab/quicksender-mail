...
$config['password_db_dsn'] = 'sqlite:////www/vmail/postfixadmin.db?mode=0646';
...
$config['password_query'] = "UPDATE mailbox SET password=%c,modified=datetime() WHERE username=%u";
